...
impl<'a, T> std::ops::Mul<T> for &'a Tetra2024<T>
where
    T: std::ops::MulAssign + Copy,
{
    type Output = Tetra2024<T>;
...
/// Addition : &Self + &Self
impl<'a, 'b, T> Add<&'b Tetra2024<T>> for &'a Tetra2024<T>
where
    T: std::ops::AddAssign + Copy,
{
    type Output = Tetra2024<T>;

    fn add(self, other: &'b Tetra2024<T>) -> Self::Output {
